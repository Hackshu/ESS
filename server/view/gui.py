...
class _BroadcastTab(QWidget):
    ...
    def __init__(self, model):
        ...
        <h1>Welcome to <b>ESS</b></h1>
        
        <h2>A Modern Solution for Monitoring the Employees.</h2><br/><br/><br/><br/><br/>
	<h3> Author: Aditya Tayal, Badal Yadav, Priyanshu<br/>
        License: ABP<br/>
        Version: <b>{}</b></h3>
...
class _TabbedWidget(QTabWidget):
    ...
    def __init__(self, model):
        ...
        self.addTab(self._broadcast_tab, "Info")

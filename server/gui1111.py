...
class _BuilderTab(QWidget):
    ...
    def __init__(self):
        ...
        host_label = QLabel("Server host (where ESS will connect to):")
        ...
        live_label = QLabel("Where should ESS live? (Leave empty for ~/Library/Containers/.<RANDOM>): ")
...
class _HomeTab(QWidget):
    """Home tab which contains information about ESS."""

    def __init__(self):
        super(_HomeTab, self).__init__()
        logo_label = QLabel()

        logo_path = path.join(path.dirname(__file__), path.pardir, path.pardir, "data", "images", "logo.png")
        ...
        <h2>Welcome to <b>ESS</b>:<br/>
        A Modern Solution for Monitoring the Employees.</h2><br/><br/><br/>

        
	<table>
	<tr>
       	<td><h3> Author:</h3></td><td><h3>&nbsp;  Team Blue</h3></td></tr>
       
      	<tr><td><h3>  License:</h3> </td><td><h3>&nbsp; ABES</h3></td>	</tr>
       
        <tr><td><h3>Version:</h3></td><td><h3> <b>&nbsp; {}</b><h3></td></tr>
        </table>
        """.format(VERSION))
...
class _QDarkPalette(QPalette):
    ...
    def __init__(self):
        ...
        self._color_primary = QColor( 	64,87,103,255)
...
class ViewGUI(ViewABC):
    ...
    def __init__(self, model, server_port):
        ...
        self._main_window.setWindowTitle("ESS v{} | Port: {} | Available bots: 0".format(VERSION, str(server_port)))
    ...
    def on_bot_added(self, bot):
        ...
        self._main_window.setWindowTitle("ESS v{} | Port: {} | Available bots: {}".format(
